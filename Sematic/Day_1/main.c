...
int main() {
  ...
  declareObject(obj);
    ...
    obj->typeAttrs->actualType = makeArrayType(10, makeArrayType(10,makeArrayType(10,makeIntType())));
    declareObject(obj);

    obj = CreateVariableObject("M");
    obj->varAttrs->type = makeArrayType(10, makeArrayType(10,makeArrayType(10,makeIntType())));
    declareObject(obj);
